    ...
    private class WebSocketConnector extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                onClose(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketConnectionHandler.CLOSE_CANNOT_CONNECT,
                        e.getMessage());
                return;
            }
            ...
            if (mTransportChannel.isConnected()) {
                ...
                try {
                    ...
                    onClose(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketConnectionHandler.CLOSE_INTERNAL_ERROR,
                            e.getMessage());
                    return;
                }
            } else {
        ...
        mMasterHandler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.obj instanceof WebSocketMessage.TextMessage) {
                    ...
                    failConnection(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketConnectionHandler.CLOSE_CONNECTION_LOST, "WebSockets connection lost");
                    ...
                    failConnection(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketConnectionHandler.CLOSE_PROTOCOL_ERROR, "WebSockets protocol violation");

                } else if (msg.obj instanceof WebSocketMessage.Error) {

                    WebSocketMessage.Error error = (WebSocketMessage.Error) msg.obj;
                    failConnection(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketConnectionHandler.CLOSE_INTERNAL_ERROR, "WebSockets internal error (" + error.mException.toString() + ")");
