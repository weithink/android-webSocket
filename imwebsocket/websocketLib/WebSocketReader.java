...
public class WebSocketReader extends Thread {
   ...
   private com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.NoCopyByteArrayOutputStream mMessagePayload;
    ...
    */
   public WebSocketReader(Handler master, SocketChannel socket, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketOptions options, String threadName) {
      ...
      mMessagePayload = new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.NoCopyByteArrayOutputStream(options.getMaxMessagePayloadSize());
   ...
   private boolean processData() throws Exception {
      ...
      if (mFrameHeader == null) {
         ...
         if (mFrameBuffer.position() >= 2) {
            ...
            if (rsv != 0) {
               throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("RSV != 0 and no extension negotiated");
            }

            if (masked) {
               // currently, we don't allow this. need to see whats the final spec.
               throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("masked server frame");
            }

            if (opcode > 7) {
               // control frame
               if (!fin) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("fragmented control frame");
               }
               if (payload_len1 > 125) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("control frame with payload length > 125 octets");
               }
               if (opcode != 8 && opcode != 9 && opcode != 10) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("control frame using reserved opcode " + opcode);
               }
               if (opcode == 8 && payload_len1 == 1) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("received close control frame with payload len 1");
               }
            } else {
               // message frame
               if (opcode != 0 && opcode != 1 && opcode != 2) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("data frame using reserved opcode " + opcode);
               }
               if (!mInsideMessage && opcode == 0) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("received continuation data frame outside fragmented message");
               }
               if (mInsideMessage && opcode != 0) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("received non-continuation data frame while inside fragmented message");
               }
            }
            ...
            if (mFrameBuffer.position() >= header_len) {
               ...
               if (payload_len1 == 126) {
                  ...
                  if (payload_len < 126) {
                     throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("invalid data frame length (not using minimal length encoding)");
                  }
                  i += 2;
               } else if (payload_len1 == 127) {
                  if ((0x80 & mFrameBuffer.get(i+0)) != 0) {
                     throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("invalid data frame length (> 2^63)");
                  }
               ...
               if (payload_len > mOptions.getMaxFramePayloadSize()) {
                  throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("frame payload too large");
               }
            ...
            if (mFrameHeader.mOpcode > 7) {
               ...
               if (mFrameHeader.mOpcode == 8) {
                  ...
                  if (mFrameHeader.mPayloadLen >= 2) {
                     ...
                     if (code < 1000
                        ...
                        throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("invalid close code " + code);
                     }
                     ...
                     if (mFrameHeader.mPayloadLen > 2) {
                        ...
                        val.validate(ra);
                        if (!val.isValid()) {
                           throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("invalid close reasons (not UTF-8)");
                        } else {
               ...
               if (framePayload != null) {
                  ...
                  if (mMessagePayload.size() + framePayload.length > mOptions.getMaxMessagePayloadSize()) {
                     throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("message payload too large");
                  }

                  // validate incoming UTF-8
                  if (mMessageOpcode == 1 && mOptions.getValidateIncomingUtf8() && !mUtf8Validator.validate(framePayload)) {
                     throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("invalid UTF-8 in text message payload");
                  }
               ...
               if (mFrameHeader.mFin) {
                  ...
                  if (mMessageOpcode == 1) {
                     ...
                     if (mOptions.getValidateIncomingUtf8() && !mUtf8Validator.isValid()) {
                        throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("UTF-8 text message payload ended within Unicode code point");
                     }
   ...
   protected void onHandshake(boolean success) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ServerHandshake(success));
   }
   ...
   protected void onClose(int code, String reason) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Close(code, reason));
   }
   ...
   protected void onPing(byte[] payload) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Ping(payload));
   }
   ...
   protected void onPong(byte[] payload) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Pong(payload));
   }
   ...
   protected void onTextMessage(String payload) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.TextMessage(payload));
   }
   ...
   protected void onRawTextMessage(byte[] payload) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.RawTextMessage(payload));
   }
   ...
   protected void onBinaryMessage(byte[] payload) {
      ...
      notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.BinaryMessage(payload));
   }
         ...
         if (mFrameBuffer.get(pos+0) == 0x0d &&
            ...
            if (mFrameBuffer.get(0) == 'H' &&
            	...
            	if (status.first >= 300) {
            		...
            		notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ServerError(status.first, status.second));
            		serverError = true;
            	}
            }
   ...
   public void run() {
         ...
         do {
            ...
            if (len > 0) {
               ...
               while (consumeData()) {
                ...
                notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Close(1000)); // Connection has been closed normally
                mStopped = true;
            } else if (len < 0) {
      ...
      } catch (com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException e) {

         if (DEBUG) Log.d(TAG, "run() : WebSocketException (" + e.toString() + ")");

         // wrap the exception and notify master
         notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ProtocolViolation(e));
