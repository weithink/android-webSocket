...
package com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib;
...
public class WebSocketWriter extends Handler {
   ...
   /// WebSockets options.
   private final com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketOptions mOptions;

   /// The send buffer that holds data to send on socket.
   private final com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.ByteBufferOutputStream mBuffer;
    ...
    */
   public WebSocketWriter(Looper looper, Handler master, SocketChannel socket, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketOptions options) {
      ...
      mSocket = socket;
      mOptions = options;
      mBuffer = new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.ByteBufferOutputStream(options.getMaxFramePayloadSize() + 14, 4*64*1024);
    ...
    */
   private void sendClientHandshake(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ClientHandshake message) throws IOException {
    ...
    */
   private void sendClose(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Close message) throws IOException,
           com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {
      ...
      if (message.mCode > 0) {
         ...
         if (payload != null && payload.length > 125) {
            throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("close payload exceeds 125 octets");
         }
    ...
    */
   private void sendPing(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Ping message) throws IOException,
           com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {
      if (message.mPayload != null && message.mPayload.length > 125) {
//         throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("ping payload exceeds 125 octets");
    ...
    */
   private void sendPong(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Pong message) throws IOException, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {
      if (message.mPayload != null && message.mPayload.length > 125) {
//         throw new WebSocketException("pong payload exceeds 125 octets");
    ...
    */
   private void sendBinaryMessage(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.BinaryMessage message) throws IOException, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {
      if (message.mPayload.length > mOptions.getMaxMessagePayloadSize()) {
         throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("message payload exceeds payload limit");
      }
    ...
    */
   private void sendTextMessage(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.TextMessage message) throws IOException, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {
    ...
    * Send WebSockets binary message.
    */
   private void sendRawTextMessage(com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.RawTextMessage message) throws IOException, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {
      if (message.mPayload.length > mOptions.getMaxMessagePayloadSize()) {
         throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("message payload exceeds payload limit");
      }
   ...
   public void handleMessage(Message msg) {
      ...
      try {
         ...
         while (mBuffer.remaining() > 0) {
    	  ...
    	  notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ConnectionLost());
      } catch (Exception e) {

         if (DEBUG) e.printStackTrace();

         // wrap the exception and notify master
         notify(new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Error(e));
      }
   }
    ...
    */
   protected void processMessage(Object msg) throws IOException, com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException {

      if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.TextMessage) {

         sendTextMessage((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.TextMessage) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.RawTextMessage) {

         sendRawTextMessage((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.RawTextMessage) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.BinaryMessage) {

         sendBinaryMessage((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.BinaryMessage) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Ping) {

         sendPing((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Ping) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Pong) {

         sendPong((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Pong) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Close) {

         sendClose((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Close) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ClientHandshake) {

         sendClientHandshake((com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.ClientHandshake) msg);

      } else if (msg instanceof com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketMessage.Quit) {
    ...
    */
   protected void processAppMessage(Object msg) throws com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException, IOException {

      throw new com.xiaohongquan.xiaohongquan.imwebsocket.websocketLib.WebSocketException("unknown message received by WebSocketWriter");
   }
}
